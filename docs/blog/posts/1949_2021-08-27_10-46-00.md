...
<h1 id="subject_show">Tarō ni mo Jirō ni mo Tarinu (太郎にも次郎にも足りぬ - Neither One Thing Nor The Other)</h1>
<div class="date" hidden>Aug 27, 2021 10:46</div>
<div id="post"><div id="body_show_ori">
Jirō ni mo Tarō ni mo Tarinu<br/><br/>To describe a halfway and useless thing, you can use the following interesting phrase:<br/><br/>'Tarō ni mo Jirō nimo tarinu' (太郎にも次郎にも足りぬ).<br/><br/>The Japanese male name, 'Tarō' (太郎), is often used for the first son, and is also used as an honorific for the most superior thing.<br/><br/>'Jirō' (次郎), containing the kanji 次 (meaning "second/next"), is also a Japanese male name, and is often used for the second son.<br/><br/>In addition, 'tarinu' (足りぬ) means "not enough."<br/><br/>Therefore, the literal meaning of 'tarō ni mo Jirō nimo tarinu' is "something is not good enough neither Taro nor Jiro."<br/><br/>Since something that can neither be first nor second is halfway, this phrase came to have the current meaning.
</div></div>
