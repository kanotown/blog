...
<h1 id="subject_show">Shigo (死語 - Dead Language/Word)</h1>
<div class="date" hidden>Apr 16, 2019 06:23</div>
<div id="post"><div id="body_show_ori">
Shigo<br/><br/>In my post yesterday, I used the Japanese word 'shigo' (死語).<br/><br/>Since 'shi' (死) means "death/dead" and 'go' (語) means "word/language," the literal meaning of 'shigo' is "dead word" or "dead language."<br/><br/>In linguistics, 'shigo' means a dead language that no one uses, but it is also used to mean a dead word that people rarely use or an antiquated word.<br/><br/>If you want to mean the latter two, you can use 'haigo' (廃語 - literally means "obsolete word"), but I think that 'shigo' is more used than 'haigo' on a daily basis.
</div></div>
