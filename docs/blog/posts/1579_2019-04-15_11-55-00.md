...
<h1 id="subject_show">Shame (写メ - Photo) Part 2</h1>
<div class="date" hidden>Apr 15, 2019 11:55</div>
<div id="post"><div id="body_show_ori">
Shame (写メ) Part 2<br/><br/>Yesterday, I introduced the slang term 'shame' (写メ), which means to take photos with (or photos taken by) a mobile phone or smartphone.<br/><br/>If you want to use 'shame' as a verb, you can say 'shame-ru' (写メる) by adding the suffix 'ru' (る).<br/><br/>For example, 'shame-rou' (写メろう) means "let's take photos (with our smartphones)."<br/><br/>I often use and hear these terms, 'shame' and 'shame-ru'.<br/><br/>However, among the current young people, it seems that these slang terms are becoming dead words because they do not use e-mails very much.
</div></div>
