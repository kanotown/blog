...
Interesting Riddles Part 1<br/><br/>Yesterday, I introduced the term 'nazonazo' (なぞなぞ), which means "riddle."<br/><br/>Next, I would like to introduce some interesting Japanese riddles.<br/><br/>Question: 'Kame to rakuda to sai ga kaimono ni ikimashita. Nani wo kau deshō?' (カメとラクダとサイが買い物に行きました。何を買うでしょう？ - "A turtle, a camel, and a rhino went shopping. What would they buy?")<br/><br/>The answer is 'kamera' (カメラ - "camera").<br/><br/>By combining 'kame' (カメ - "turtle"), 'rakuda' (ラクダ - "camel"), and 'sai' (サイ - "rhino"), it becomes 'kamera kudasai' (カメラ下さい - "Please give me a camera").
</div></div>
