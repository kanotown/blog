...
<h1 id="subject_show">Nen ni wa Nen wo Ireru (念には念を入れる - Taking Extra Precautions)</h1>
<div class="date" hidden>Jul 29, 2023 17:42</div>
<div id="post"><div id="body_show_ori">
Nen ni wa Nen wo Ireru<br/><br/>I often make various mistakes.<br/><br/>Such people should always try to 'nen ni wa nen wo ireru' (念には念を入れる).<br/><br/>Since 'nen' (念) means "care/precaution," and 'ireru' (入れる) means "to put," the literal meaning of 'nen wo ireru' (念を入れる) is "to put care/precaution (into one's mind)."<br/><br/>By adding 'nen ni wa' (念には) to make 'nen ni wa nen wo ireru', it can mean taking extra precautions or paying extra attention.<br/><br/>In addition, by using the imperative form of 'ireru', which is 'ireyo' (入れよ), it becomes the proverb, 'nen ni wa nen wo ireyo' (念には念を入れよ - "Better safe than sorry").
</div></div>
