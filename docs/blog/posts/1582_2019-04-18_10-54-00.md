...
<h1 id="subject_show">Hachiku no Ikioi (破竹の勢い - Tremendous Momentum)</h1>
<div class="date" hidden>Apr 18, 2019 10:54</div>
<div id="post"><div id="body_show_ori">
Hachiku no Ikioi<br/><br/>When something has an intense momentum and it can't be stopped, you can describe that using the Japanese idiom 'hachiku no ikioi' (破竹の勢い).<br/><br/>'Ha' (破) means "to break," 'chiku' (竹) means "bamboo," and 'ikioi' (勢い) means "momentum," so the literal meaning of 'hachiku no ikioi' is "a momentum of breaking a bamboo."<br/><br/>If you try to divide a bamboo into two with a knife, it will break swiftly from the top to the bottom.<br/><br/>Because of this, 'hachiku' (破竹 - "breaking a bamboo") came to mean "an intense momentum that can't be stopped."
</div></div>
